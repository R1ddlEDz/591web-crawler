...
## 使用方法
在bash裡使用 **python main.py** 或 **python crawler/utils.py** 後，將會自動開始爬蟲。若需要改其他縣市請到**main.py**裡做修改


為了避免讓伺服器負載，再加上爬蟲的資料太大量，將會花費5-15小時進行爬蟲(視查詢的房屋數決定時間)。若要終止請在bash裡使用**Ctrl + C**。
